...
const SnipcartButton = ({pid, url, category, country, display_name, process, image, price_200g, price_500g, price_1kg, price_dripbag, price_gb, children, defaultPackageOpt, orderType}) => {
  ...
  const packages = special ? '5 x 50g' : PO_200g + str500g + str1kg ;

  if ( orderType === productType.DRIP_BAGS ) {
   return (
    <button 
      className="snipcart-add-item"
      data-item-id={pid}
      data-item-price={price_dripbag}
      data-item-url={url}
      ...
      data-item-custom2-options={ PO_dripbag }
      data-item-custom2-value={ PO_dripbag }
  ...
  // default button for roasted beans
  return (
    <button 
      className="snipcart-add-item"
      data-item-id={pid}
